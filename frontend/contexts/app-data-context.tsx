...
export function AppDataProvider({ children }: { children: ReactNode }) {
  const [state, setState] = useState<AppState>({
    ...
    spikeRisk: 0,
    spikeFactors: [],
    wearable: { connected: false, heartRate: null, steps: null, activeMinutes: null, sleepHours: null, sleepQuality: null, lastSync: null },
    isLoading: true,
  })
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      const [glucose, meals, activities, sleep, timeline, score, wearable] = await Promise.all([
      ...
      setState({
        ...
        wearable: {
          ...
          heartRate: wearable.heart_rate ?? null,
          steps: wearable.steps ?? null,
          activeMinutes: wearable.active_minutes ?? null,
          sleepHours: wearable.sleep_hours ?? null,
          sleepQuality: wearable.sleep_quality ?? null,
          lastSync: wearable.last_sync ?? null,
        },
        isLoading: false,
      })
    } catch {
