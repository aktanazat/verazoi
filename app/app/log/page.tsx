...
export default function LogPage() {
  ...
  const saveLabel = saved ? "Saved" : tab === "glucose" ? "Save reading" : tab === "meals" ? "Save meal" : tab === "activity" ? "Save activity" : "Save sleep"
  ...
  return (
    <div>
      ...
      <div className="mt-6 grid grid-cols-4 border border-border">
        {tabs.map((t) => (
          <button
            key={t.key}
      ...
      <div className="mt-6">
        {/* Glucose */}
        <div className={tab === "glucose" ? "" : "hidden"}>
        ...
        <div className={tab === "meals" ? "" : "hidden"}>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="border border-border p-5">
              <label className="text-[12px] uppercase tracking-[0.15em] text-muted-foreground">Meal type</label>
              ...
              <div className="mt-5">
                <label className="text-[12px] uppercase tracking-[0.15em] text-muted-foreground">What did you eat?</label>
            ...
            <div className="flex flex-col gap-5">
              {selected.length > 0 && (
                <div className="border border-border p-5">
                  <label className="text-[12px] uppercase tracking-[0.15em] text-muted-foreground">Selected ({selected.length})</label>
                  <div className="mt-3 flex flex-wrap gap-2">
                    {selected.map((food) => (
              ...
              <div className="border border-border p-5">
                <label className="text-[12px] uppercase tracking-[0.15em] text-muted-foreground">Notes (optional)</label>
                <textarea
                  value={notes}
        ...
        <div className={tab === "activity" ? "" : "hidden"}>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="border border-border p-5">
              <label className="text-[12px] uppercase tracking-[0.15em] text-muted-foreground">Type</label>
              ...
              <div className="mt-5">
                <label className="text-[12px] uppercase tracking-[0.15em] text-muted-foreground">Duration</label>
              ...
              <div className="mt-5">
                <label className="text-[12px] uppercase tracking-[0.15em] text-muted-foreground">Intensity</label>
            ...
            <div className="border border-border p-5">
              ...
              <div className="mt-4 flex flex-col">
                {state.activities.length === 0 && state.timeline.filter((e) => e.type === "activity").map((e, i) => (
                  <div key={i} className="flex items-center justify-between border-b border-border py-3 last:border-0">
                    <div>
                ...
                {state.activities.map((a, i) => (
                  <div key={i} className="flex items-center justify-between border-b border-border py-3 last:border-0">
                    <div>
                      <p className="text-[13px] text-foreground">{a.activityType}</p>
                      <p className="mt-0.5 text-[12px] text-muted-foreground">{a.duration} min, {a.intensity.toLowerCase()}</p>
                    </div>
        ...
        {/* Sleep */}
        <div className={tab === "sleep" ? "" : "hidden"}>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="border border-border p-5">
              <label className="text-[12px] uppercase tracking-[0.15em] text-muted-foreground">Hours slept</label>
              <div className="mt-2 flex items-baseline gap-2">
                <input
                  type="number"
                  step="0.5"
              ...
              <div className="mt-5">
                <label className="text-[12px] uppercase tracking-[0.15em] text-muted-foreground">Quality</label>
            ...
            <div className="border border-border p-5">
              ...
              <div className="mt-4 flex flex-col">
                {state.sleepEntries.length === 0 && state.timeline.filter((e) => e.type === "sleep").map((e, i) => (
                  <div key={i} className="flex items-center justify-between border-b border-border py-3 last:border-0">
                    <div>
                      <p className="text-[13px] text-foreground">{e.label}</p>
                      <p className="mt-0.5 text-[12px] text-muted-foreground">{e.value}</p>
                ...
                {state.sleepEntries.map((s, i) => (
                  <div key={i} className="flex items-center justify-between border-b border-border py-3 last:border-0">
                    <div>
                      <p className="text-[13px] text-foreground">Sleep logged</p>
                      <p className="mt-0.5 text-[12px] text-muted-foreground">{s.hours} hrs, {s.quality}</p>
                    </div>
                    <span className="text-[11px] text-muted-foreground/70">{s.time}</span>
                  </div>
                ))}
              </div>
            </div>
